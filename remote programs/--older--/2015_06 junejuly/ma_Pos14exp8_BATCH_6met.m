...
filestring = '../RESEARCH!!!/researchdata/experimental_data/100714 Animal cap x0.8 Scion x2_0/Pos14_exp8/';
...
nameofsavedfile = strcat('Pos14exp8_',growthfunction,'_fixalpha');

[param_new,min_quantity,exitflag] = batchparamestim2_fixalpha(Fk,kb,alpha,nameofsavedfile);
