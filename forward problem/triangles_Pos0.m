...
filestring = '../../../../../RESEARCH!!!/researchdata/experimental_data/2014-06-11_ACTriangles/Pos0/';
...
%%%--------------------------- generate mesh ---------------------------%%%
number_nodes = 100;
exp_px = [736,614]; %size of experimental window in pixels
