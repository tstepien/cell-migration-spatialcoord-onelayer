...
groups_Fk = {'A','BC','D','D','AE',...
    '***','BE','C','***','***',...
    'F','***','FG','A','***',...
    '***','G','***'};
color_Fk = [co_light(1,:);co_light(2,:);co_light(3,:);co_light(3,:);co_light(1,:);...
    co_light(end,:);co_light(2,:);co_light(2,:);co_light(end,:);co_light(end,:);...
...
groups_alpha = {'AB','AC','DE','D','BCEFG',...
    'DEG','CEFH','CEFHIJ','AB','A',...
    'CEFH','BCG','DFJ','DH','DI',...
    'BCEJ','DHJ','***'};
color_alpha = [co_light(5,:);co_light(5,:);co_dark(2,:);co_dark(2,:);co_light(5,:);...
    co_dark(2,:);co_dark(2,:);co_light(5,:);co_light(5,:);co_light(5,:);...
    co_light(5,:);co_light(5,:);co_dark(2,:);co_dark(2,:);co_dark(2,:);...
...
groups_rho0 = {'A','BC','A','A','AD',...
    'AB','BD','EF','GH','G',...
    'EHI','GHI','EHI','EFI','CF',...
    'G','GI','***'};
color_rho0 = [co_dark(3,:);co_dark(4,:);co_dark(3,:);co_dark(3,:);co_dark(3,:);...
    co_dark(3,:);co_dark(4,:);co_dark(5,:);co_dark(6,:);co_dark(6,:);...
    co_dark(5,:);co_dark(6,:);co_dark(5,:);co_dark(5,:);co_dark(4,:);...
