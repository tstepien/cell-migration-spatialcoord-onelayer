...
color_Fk = [co_light(1,:);co_light(2,:);co_light(3,:);co_light(3,:);co_light(1,:);...
    co_light(3,:);co_light(1,:);co_light(2,:);co_light(4,:);co_light(end,:);...
    co_light(3,:);co_light(4,:);co_light(3,:);co_light(5,:);co_light(5,:);...
    co_light(4,:);co_light(3,:);co_light(end,:)];
...
groups_alpha = {'ABE','BCD','BCD','BCD','BCD',...
    ...
    'BCD','BCD','BCD','CE','CE',...
    'BCD','C','A'};
color_alpha = [co_dark(1,:);co_dark(2,:);co_dark(2,:);co_dark(2,:);co_dark(2,:);...
    co_dark(2,:);co_dark(2,:);co_dark(2,:);co_dark(1,:);co_dark(1,:);...
    co_dark(2,:);co_dark(2,:);co_dark(2,:);co_dark(3,:);co_dark(3,:);...
    co_dark(2,:);co_dark(3,:);co_dark(1,:)];
...
groups_rho0 = {'A','AB','AC','A','A',...
    ...
    'BFG','FHI','BEH','BCH','BCH',...
    'GIJ','BI','J'};
color_rho0 = [co_dark(4,:);co_dark(4,:);co_dark(4,:);co_dark(4,:);co_dark(4,:);...
    co_dark(4,:);co_dark(4,:);co_dark(5,:);co_dark(5,:);co_dark(6,:);...
    co_dark(5,:);co_dark(6,:);co_dark(5,:);co_dark(5,:);co_dark(5,:);...
    co_dark(7,:);co_dark(5,:);co_dark(7,:)];
