function Phi_new = levelset_reinitialize(Phi,dtau,order,g,reinit)
...
while flag && iter < reinit_ITERMAX
    pn = Phi_old;
    [DxL,DxR,DyL,DyR] = levelset_WENO2D(pn,g);
    ...
    if order == 1
        ...
        [DxL,DxR,DyL,DyR] = levelset_WENO2D(pn_1,g);
        ...
        if order == 2
            ...
            [DxL,DxR,DyL,DyR] = levelset_WENO2D(pn_1_2,g);
