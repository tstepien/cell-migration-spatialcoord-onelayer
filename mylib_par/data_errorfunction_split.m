function [err_dist,err_densratio] = ...
    data_errorfunction_split(density,curve,exp_scale,filestring,g)
% [min_quantity,err_dist,err_densratio] = data_errorfunction_split(density,curve)
%
