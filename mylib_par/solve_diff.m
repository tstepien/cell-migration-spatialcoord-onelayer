function C_new = solve_diff(param,lapl,C_old,Phi_old,Phi_new,dt,g,init_cond)
...
lapl_cut = laplacian_cut(lapl,Phi_new,g);
[Dt,C_cut] = time_stepping(Phi_new,Phi_old,dt,C_cut,g,init_cond);

[M,b,C_cut] = laplacian_update(param,lapl_cut,Phi_new,Dt,C_cut,g,init_cond);
