...
for i = 1:3
    %%% row 1: images
    ax1 = subaxis(6,3,i,1,'SpacingHoriz', spacing_horiz, 'SpacingVert', spacing_vert, ...
    ...
    %%% row 2: boundaries
    subaxis(6,3,i,2,'SpacingHoriz', spacing_horiz, 'SpacingVert', spacing_vert, ...
    ...
    %%% row 3: epsx data
    ax3 = subaxis(6,3,i,3,'SpacingHoriz', spacing_horiz, 'SpacingVert', spacing_vert, ...
        'Padding', 0, 'PaddingTop',0.015,'PaddingLeft',paddingleft(i), ...
    ...
    %%% row 4: epsxy=epsyx data
    ax4 = subaxis(6,3,i,4,'SpacingHoriz', spacing_horiz, 'SpacingVert', spacing_vert, ...
        'Padding', 0, 'PaddingTop',0.015,'PaddingLeft',paddingleft(i), ...
    ...
    if i==3
        h6 = colorbar;
        set(h6, 'Location','East', 'Position',[0.869 0.33467 0.037 0.148063]);
    end
    
    %%% row 5: epsy data
    ax5 = subaxis(6,3,i,5,'SpacingHoriz', spacing_horiz, 'SpacingVert', spacing_vert, ...
        'Padding', 0, 'PaddingTop',0.005,'PaddingLeft',paddingleft(i), ...
        'Margin', 0,'MarginRight',marginright(i),'PaddingBottom',0.005);
    ...
    %%% row 6: density ratio from data
    ax6 = subaxis(6,3,i,6,'SpacingHoriz', spacing_horiz, 'SpacingVert', spacing_vert, ...
    ...
    colormap(ax6,mymap_hot)%flipud(pmkmp(64,'LinLhot')))
    
    if i==3
        h6 = colorbar;
        set(h6, 'Location','East', 'Position',[0.869 0.0093 0.037 0.1507]);
    end
