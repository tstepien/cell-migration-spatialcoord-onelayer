...
filestring = '../../../../RESEARCH!!!/researchdata/experimental_data/SizeGapData/2014_02_26/Pos7/';
...
%%%------------------------- model parameters --------------------------%%%
param.Fk   = 0.2018747837;
param.kb   = 24726.387903835;
% scaling    = 10^6;
...
%%%--------------------------- generate mesh ---------------------------%%%
number_nodes = 150;
exp_px = [756,767]; %size of experimental window in pixels
...
elseif paramestim == 1
    ...
    savefile = strcat('paramestim/0226/Pos7a',...
