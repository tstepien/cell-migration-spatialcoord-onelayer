...
if paramestim == 0
    param.rho0 = rho0;
    [density,curve,velocity,Phi,plot_times] = onelayer_Fk_varies(param);
elseif paramestim == 1
    ...
    [param_new,min_quantity,exitflag] = fminsearch(@paramestimation_Fk_varies,[param.Fkintcpt,...
        param.Fkslope,param.kb],options);
    
    savefile = strcat('paramestim/shirleyma/Pos5_exp2_Fk_varies_a',...
        sprintf('_Fkintcpt_%g_Fkslope_%g_kb_%g.mat',param.Fkintcpt,...
        param.Fkslope,param.kb));
