...
filestring = '../../../../RESEARCH!!!/researchdata/experimental_data/100714 Animal cap x0.8 Scion x2_0/Pos8_exp4/';
...
%%%------------------------- model parameters --------------------------%%%
% param.Fk   = 0.8241628599;
% param.kb   = 10030.1436312947;
% scaling    = 10^6;
...
%%%--------------------------- generate mesh ---------------------------%%%
number_nodes = 150;
exp_px = [356,327]; %size of experimental window in pixels
