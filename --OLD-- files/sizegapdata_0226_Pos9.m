...
filestring = '../../../../RESEARCH!!!/researchdata/experimental_data/SizeGapData/2014_02_26/Pos9/';
...
%%%------------------------- model parameters --------------------------%%%
param.Fk   = 0.3401356759;
param.kb   = 20628.297758705;
% scaling    = 10^6;
...
%%%--------------------------- generate mesh ---------------------------%%%
number_nodes = 150;
exp_px = [885,880]; %size of experimental window in pixels
...
elseif paramestim == 1
    ...
    savefile = strcat('paramestim/0226/Pos9a',...
