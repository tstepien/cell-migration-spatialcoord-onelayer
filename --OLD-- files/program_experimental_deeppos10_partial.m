...
filestring = '../../../../RESEARCH!!!/researchdata/experimental_data/DeepLayerPos10_from60/';
...
elseif paramestim == 1
    ...
    options = optimset('MaxIter',2000,'MaxFunEvals',1000,'Display','iter');
    param_new = fminsearch(@paramestimation,[param.Fk,param.kb,...
                                                      param.rho0],options);
    
    save('deeppos10_partial_param.mat','param_new');
end
