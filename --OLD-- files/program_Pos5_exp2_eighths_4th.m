...
filestring = '../../../../RESEARCH!!!/researchdata/experimental_data/100714 Animal cap x0.8 Scion x2_0/Pos5_exp2/eighths_4th/';
...
%%%------------------------- model parameters --------------------------%%%
param.Fk   = 0.2305895299;
param.kb   = 8644.1212151226;
% scaling    = 10^6;
...
elseif paramestim == 1
    ...
    savefile = strcat('paramestim/shirleyma/Pos5_exp2_eighths_4th',...
