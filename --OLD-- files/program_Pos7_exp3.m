...
filestring = '../../../../RESEARCH!!!/researchdata/experimental_data/100714 Animal cap x0.8 Scion x2_0/Pos7_exp3/';
...
%%%------------------------- model parameters --------------------------%%%
% param.Fk   = 1.1303439932;
% param.kb   = 9230.2669919493;
% scaling    = 10^6;
...
%%%--------------------------- generate mesh ---------------------------%%%
number_nodes = 150;
exp_px = [322,332]; %size of experimental window in pixels
