...
filestring = '../../../../RESEARCH!!!/researchdata/experimental_data/100714 Animal cap x0.8 Scion x2_0/Pos5_exp2/eighths_6th/';
...
%%%------------------------- model parameters --------------------------%%%
param.Fk   = 0.3518323047;
param.kb   = 9406.3000037534;
% scaling    = 10^6;
...
elseif paramestim == 1
    ...
    savefile = strcat('paramestim/shirleyma/Pos5_exp2_eighths_6th',...
