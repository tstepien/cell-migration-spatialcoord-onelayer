...
filestring = '../../../../RESEARCH!!!/researchdata/experimental_data/100714 Animal cap x0.8 Scion x2_0/Pos5_exp2/first_half/';
...
%%%------------------------- model parameters --------------------------%%%
param.Fk   = 0.5242310598;
param.kb   = 10977.7104692166;
% scaling    = 10^6;
...
elseif paramestim == 1
    ...
    savefile = strcat('paramestim/shirleyma/Pos5_exp2_firsthalf_a',...
