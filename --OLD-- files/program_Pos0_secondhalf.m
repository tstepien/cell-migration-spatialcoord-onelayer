...
filestring = '../../../../RESEARCH!!!/researchdata/experimental_data/100714 Animal cap x0.8 Scion x2_0/Pos0/second_half/';
...
%%%------------------------- model parameters --------------------------%%%
param.Fk   = 0.4191547711;
param.kb   = 69684.3169052193;
% scaling    = 10^6;
...
elseif paramestim == 1
    ...
    savefile = strcat('paramestim/shirleyma/Pos0_secondhalf_a',...
