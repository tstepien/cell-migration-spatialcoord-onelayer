...
%%%------------------------- model parameters --------------------------%%%
param.Fkintcpt = 0.5368913423;
param.Fkslope  = 0.010904224;
param.kbintcpt = 16453.5833638794;
param.kbslope = 112.6062889776;
% scaling    = 10^6;
...
elseif paramestim == 1
    ...
    [param_new,min_quantity,exitflag] = fminsearch(...
        @paramestimation_Fk_kb_varies,[param.Fkintcpt,...
        param.Fkslope,param.kbintcpt,param.kbslope],options);
    
    savefile = strcat('paramestim/shirleyma/Pos5_exp2_Fk_kb_varies_a',...
