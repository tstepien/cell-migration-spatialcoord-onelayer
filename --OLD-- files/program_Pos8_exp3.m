...
filestring = '../../../../RESEARCH!!!/researchdata/experimental_data/100714 Animal cap x0.8 Scion x2_0/Pos8_exp3/';
...
%%%------------------------- model parameters --------------------------%%%
% param.Fk   = 0.8879181321;
% param.kb   = 11442.2851562144;
% scaling    = 10^6;
...
%%%--------------------------- generate mesh ---------------------------%%%
number_nodes = 150;
exp_px = [373,348]; %size of experimental window in pixels
