...
filestring = '../../../../RESEARCH!!!/researchdata/experimental_data/100714 Animal cap x0.8 Scion x2_0/Pos5_exp2/fourth_quarter/';
...
%%%------------------------- model parameters --------------------------%%%
param.Fk = 0.2881435312;
param.kb = 48667.5897677951;
% scaling    = 10^6;
rho0 = 1000;%0.001*scaling;

%%%-------------------------- time parameters --------------------------%%%
time.end = ((30-1)*5)/60; %%% how long simulation runs in hours
...
elseif paramestim == 1
    ...
    savefile = strcat('paramestim/shirleyma/Pos5_exp2_fourth_quarter',...
