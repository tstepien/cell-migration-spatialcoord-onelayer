...
filestring = '../../../../RESEARCH!!!/researchdata/experimental_data/SizeGapData/2014_02_26/Pos4/';
...
%%%------------------------- model parameters --------------------------%%%
param.Fk   = 0.3913526936;
param.kb   = 5997.8938573209;
% scaling    = 10^6;
...
%%%--------------------------- generate mesh ---------------------------%%%
number_nodes = 150;
exp_px = [812,778]; %size of experimental window in pixels
...
elseif paramestim == 1
    ...
    savefile = strcat('paramestim/0226/Pos4a',...
