...
filestring = '../../../../RESEARCH!!!/researchdata/experimental_data/100714 Animal cap x0.8 Scion x2_0/Pos8_exp1/';
...
%%%------------------------- model parameters --------------------------%%%
% param.Fk   = 0.8466567185;
% param.kb   = 8528.9604828829;
% scaling    = 10^6;
...
%%%--------------------------- generate mesh ---------------------------%%%
number_nodes = 150;
exp_px = [318,303]; %size of experimental window in pixels
