...
filestring = '../../../../RESEARCH!!!/researchdata/experimental_data/100714 Animal cap x0.8 Scion x2_0/Pos10_exp2/second_half/';
...
%%%------------------------- model parameters --------------------------%%%
param.Fk   = 0.570735699;
param.kb   = 12002.0206171335;
% scaling    = 10^6;
rho0 = 1000;%0.001*scaling;

%%%-------------------------- time parameters --------------------------%%%
time.end = ((60-1)*5)/60; %%% how long simulation runs in hours
time.exp_step = 5/60; %%% how many hours between recording a curve

%%%--------------------------- generate mesh ---------------------------%%%
number_nodes = 150;
exp_px = [240,337]; %size of experimental window in pixels
...
elseif paramestim == 1
    ...
    [param_new,min_quantity,exitflag] = fminsearch(@paramestimation_2param,[param.Fk,param.kb],...
        options);

    savefile = strcat('paramestim/shirleyma/Pos10_exp2_secondhalf_a',...
