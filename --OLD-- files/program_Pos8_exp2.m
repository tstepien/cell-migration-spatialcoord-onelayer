...
filestring = '../../../../RESEARCH!!!/researchdata/experimental_data/100714 Animal cap x0.8 Scion x2_0/Pos8_exp2/';
...
%%%------------------------- model parameters --------------------------%%%
% param.Fk   = 0.7509477587;
% param.kb   = 9194.5208025203;
% scaling    = 10^6;
...
%%%--------------------------- generate mesh ---------------------------%%%
number_nodes = 150;
exp_px = [324,309]; %size of experimental window in pixels
