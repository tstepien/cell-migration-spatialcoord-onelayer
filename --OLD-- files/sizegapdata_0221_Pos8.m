...
filestring = '../../../../RESEARCH!!!/researchdata/experimental_data/SizeGapData/2014_02_21/Pos8/';
...
%%%------------------------- model parameters --------------------------%%%
param.Fk   = 0.5627348401;
param.kb   = 13862.0786302664;
% scaling    = 10^6;
...
%%%--------------------------- generate mesh ---------------------------%%%
number_nodes = 150;
exp_px = [884,780]; %size of experimental window in pixels
...
elseif paramestim == 1
    ...
    savefile = strcat('paramestim/0221/Pos8a',...
