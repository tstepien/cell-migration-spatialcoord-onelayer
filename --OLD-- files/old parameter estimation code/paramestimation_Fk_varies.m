function min_quantity = paramestimation_Fk_varies(param)
% min_quantity = paramestimation_Fk_varies(param)
%
% parameter estimation file that contains minimization function
%
% input:
%   param = parameters (vector with Fkintcpt,Fkslope,kb)
...
if param(1)+param(2)*time.end<=0 || param(3)<=0
    min_quantity = 10^20;
    return
end
...
[density,curve] = onelayer_Fk_varies(simparam);
