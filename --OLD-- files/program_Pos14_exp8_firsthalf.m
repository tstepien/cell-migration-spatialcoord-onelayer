...
filestring = '../../../../RESEARCH!!!/researchdata/experimental_data/100714 Animal cap x0.8 Scion x2_0/Pos14_exp8/first_half/';
...
%%%------------------------- model parameters --------------------------%%%
param.Fk   = 0.7395095223;
param.kb   = 4622.6470044375;
% scaling    = 10^6;
...
elseif paramestim == 1
    ...
    savefile = strcat('paramestim/shirleyma/Pos14_exp8_firsthalf_a',...
