...
filestring = '../../../../RESEARCH!!!/researchdata/experimental_data/100714 Animal cap x0.8 Scion x2_0/Pos5_exp2/eighths_8th/';
...
%%%------------------------- model parameters --------------------------%%%
param.Fk   = 0.2265468127;
param.kb   = 45883.6909999303;
% scaling    = 10^6;
rho0 = 1000;%0.001*scaling;

%%%-------------------------- time parameters --------------------------%%%
time.end = ((15-1)*5)/60; %%% how long simulation runs in hours
...
elseif paramestim == 1
    ...
    savefile = strcat('paramestim/shirleyma/Pos5_exp2_eighths_8th',...
