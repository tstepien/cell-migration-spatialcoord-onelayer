...
filestring = 'experimental_data/shirleyma/Pos5_exp2/';
...
elseif paramestim == 1
    ...
    param_new = fminsearch(@paramestimation_kb_varies,[param.Fk,...
        param.kbintcpt,param.kbslope],options);
    
    savefile = strcat('paramestim/shirleyma/Pos5_exp2_kb_varies_d',...
        sprintf('_Fk_%g_kbintcpt_%g_kbslope_%g.mat',param.Fk,...
        param.kbintcpt,param.kbslope));
