...
filestring = '../../../../RESEARCH!!!/researchdata/experimental_data/SizeGapData/2014_02_26/Pos6/';
...
%%%------------------------- model parameters --------------------------%%%
param.Fk   = 0.1955352781;
param.kb   = 10863.9678999886;
% scaling    = 10^6;
...
%%%--------------------------- generate mesh ---------------------------%%%
number_nodes = 150;
exp_px = [828,783]; %size of experimental window in pixels
...
elseif paramestim == 1
    ...
    savefile = strcat('paramestim/0226/Pos6a',...
