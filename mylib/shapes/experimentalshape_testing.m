function Phi0 = experimentalshape_testing(file_bdy,file_mask,exp_scale)
% Phi0 = experimentalshape(file_bdy,file_mask,exp_size)
%
...
interpol = mask>0;%%%interp2(xMask,yMask,mask,g.Xnew,g.Ynew)>0;
