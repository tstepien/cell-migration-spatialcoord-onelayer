function [C_new,newmassadded] = logistic_then_exponential(param,C_old,dt,t,massadded)
% [C_new,newmassadded] = logistic_then_exponential(param,C_old,dt,t,massadded)
%
